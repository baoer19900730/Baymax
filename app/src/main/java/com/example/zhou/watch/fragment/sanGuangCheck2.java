...
public class sanGuangCheck2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sangguang_checked2, container, false);
        againChecked = (Button) view.findViewById(R.id.sanguang2_again);
